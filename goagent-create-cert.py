...
def main(host):
    CertUtil.check_ca()
    CertUtil.get_cert(host)

if __name__ == '__main__':
    try:
        parser = argparse.ArgumentParser(description='Create cert & key for host')
        parser.add_argument('host', type=str,
                           help='Please put the correct CA.key and CA.crt files in the same folder with this script\nhost name, example: www.pandora.com')
